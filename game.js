...
class Game {
    constructor() {
        ...
        this.gizmo = new Gizmo(document.getElementById('gizmo-container'));
    ...
    initializeBoard() {
        ...
        this.gizmo.init(); // Init gizmo to set up scene, but don't start animation yet.
    }
